...
public final class NetUtils
{
	 ...
	 * @return	URLConnection A pointer to aConnection.
	 */
	public static HttpURLConnection prepareHttpGetL(String aUrl,
			...
			throws MalformedURLException, IOException, ProtocolException
	{
		...
		try
		{
			con=(HttpURLConnection)(openConnectionL(aUrl));
		}
		catch(MalformedURLException e)
		{
			throw e;
...
//		Log.d(TAG, "content-length: " + con.getContentLength());
		...
		con=(HttpURLConnection)(addHeaderFields(con, aHeaderFields));
	 ...
	 * @return	URLConnection A pointer to aConnection.
	 */
	public static HttpURLConnection prepareHttpPostL(String aUrl,
		int aConnectTimeout, int aReadTimeout,
		Map<String, String> aHeaderFields)
			throws MalformedURLException, IOException, ProtocolException
	{
